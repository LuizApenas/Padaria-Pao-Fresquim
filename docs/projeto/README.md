...
Diretório com os artefatos centrais de referência do projeto.
...
Este diretório deve ser tratado como fonte de verdade funcional do projeto até a implementação começar.
